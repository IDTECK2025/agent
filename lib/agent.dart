...
// API Service Class
class ApiService {
  static const String baseUrl = 'Apidartapi';
  ...
  static Future<Map<String, dynamic>> createShareholder({
    ...
    try {
      ...
      final url = Uri.parse('$baseUrl/users/agents');
...
class _ShareHolderFormScreenState extends State<ShareHolderForm> {
  ...
  String _getStepTitle() {
    switch (currentStep) {
      case 1:
        return 'Fill your personal details';
      case 2:
        return 'Add your bank details';
      case 3:
        return 'Add your address details';
      case 4:
  ...
  String _getStepDescription() {
    switch (currentStep) {
      case 1:
        return 'We need your personal information for identity verification and account setup';
      case 2:
        return 'Please provide your bank account details for payment processing and verification';
      case 3:
        return 'Please provide your address and location information';
      case 4:
        return 'Please review all the information below and confirm to complete your registration';
      default:
    ...
    if (isMobile) {
      return Column(
        children: [
          ...
          const SizedBox(height: 16),
          _buildDateField('Date of Birth', _dobController, isRequired: true),
          const SizedBox(height: 16),
          // _buildPasswordField(
          //   'Password',
          //   _passwordController,
      ...
      children: [
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: Icon(
              UIcons.regularRounded.calendar_pen,
              color: kPrimaryColor,
              size: 17,
            ),
            contentPadding: const EdgeInsets.symmetric(
